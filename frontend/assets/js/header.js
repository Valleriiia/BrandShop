    ...
    <div class="container">
        <div class="header__container">
                ...
                <div class="burger__menu">
                    <div class="container">
                        ...
                        <ul class="header__list">
                            ...
                            <li class="header__item">
                                <a href="/page/love.html" class="header__link">Улюблені</a>
                            </li>
                            <li class="header__item">
            ...
            <div class="h__right">
                ...
                <a class="backet" href="/page/cart.html">
                    <svg class="desk" xmlns="http://www.w3.org/2000/svg" width="15" height="24" viewBox="0 0 15 24"
                        fill="none">
